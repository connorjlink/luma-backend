...
impl ApplicationHandler for App
{
    fn resumed(&mut self, event_loop: &winit::event_loop::ActiveEventLoop)
    {
        ...
        {
            attributes = attributes.with_title(self.title.clone());
        }
...
impl Renderer
{
    ...
    ) 
    {
        ...
        // limit the borrow scope of the encoder
        {
...
impl Scene {
    ...
    pub fn update(&mut self, queue: &wgpu::Queue, aspect_ratio: f32, delta_time: f32)
    {
        ...
        (
            queue,
            0,
            UniformBuffer { mvp: projection * view * self.model },
        );
    }
...
const VERTICES: [geometry::Vertex; 3] =
[
    geometry::Vertex
    {
